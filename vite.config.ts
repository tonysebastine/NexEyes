      ...
      output: {
        manualChunks(id) {
          if (id.includes('node_modules')) {
            ...
            // Globe.gl + Three.js: keep separate from deck.gl to allow independent loading
            if (id.includes('/globe.gl/') || (id.includes('/three/') && !id.includes('/@deck') && !id.includes('/@luma'))) {
              return 'globe';
            }
            if (
              id.includes('/@deck.gl/')
            ...
            if (id.includes('/topojson-client/') || id.includes('/supercluster/')) {
              return 'geo-utils';
            }
