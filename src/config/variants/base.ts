...
export const STORAGE_KEYS = {
  panels: 'godseye-panels',
  monitors: 'godseye-monitors',
  mapLayers: 'godseye-layers',
  disabledFeeds: 'godseye-disabled-feeds',
  liveChannels: 'godseye-live-channels',
  mapMode: 'godseye-map-mode',          // 'flat' | 'globe'
} as const;
