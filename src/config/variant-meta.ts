...
export const VARIANT_META: { full: VariantMeta;[k: string]: VariantMeta } = {
  full: {
    title: 'GodsEye - Real-Time Global Intelligence Dashboard',
  ...
  tech: {
    title: 'GodsEye Tech - Real-Time AI & Tech Industry Dashboard',
    ...
    siteName: 'GodsEye Tech',
    shortName: 'GodsEyeTech',
  ...
  happy: {
    title: 'GodsEye Happy - Good News & Global Progress',
    ...
    siteName: 'GodsEye Happy',
    shortName: 'GodsEyeHappy',
  ...
  finance: {
    title: 'GodsEye Finance - Real-Time Markets & Trading Dashboard',
    ...
    siteName: 'GodsEye Finance',
    shortName: 'GodsEyeFinance',
